      ...
      <div className="relative z-10 w-full px-6 lg:px-12 xl:px-20">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="text-center mb-16">
            ...
            >
              Let's stay in <span className="text-gradient-gold">touch</span>
            </h2>
            ...
            >
              Our team is available to discuss your projects and support you in achieving your objectives.
            </p>
          </div>
              ...
              >
                <div className="relative p-8 rounded-2xl bg-navy-light border border-white/10 hover:border-gold/30 transition-all h-full group">
                  ...
                  <div className="flex items-center gap-3 mb-6">
                    ...
                    <h3 className="font-serif text-2xl font-semibold text-white">{office.city}</h3>
                  </div>
